...
declare const _default: ({ confirmText, confirmTextColor, toolbarBackground, toolbarBorderColor, fontSizeToolbar, fontFamilyConfirmText, onConfirm, }: Props) => React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)>;
/**
